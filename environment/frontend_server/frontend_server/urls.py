...
urlpatterns = [
    ...
    url(
        r"^conspiracy_beliefs/(?P<sim_code>[\w-]+)/(?P<step>[\w-]+)/(?P<persona_name>[\w-]+)/$",
        translator_views.conspiracy_beliefs,
        name="conspiracy_beliefs",
    ),
    url(
        r"^conspiracy_comparison/(?P<sim_code>[\w-]+)/(?P<step>[\w-]+)/$",
        translator_views.conspiracy_comparison,
        name="conspiracy_comparison",
    ),
    url(
